...
export const fnShouldOnlyBeCallableByGovernance = createOnlyCallableCheck('governance', 'OnlyGovernance()');

export const fnShouldOnlyBeCallableByPendingGovernance = createOnlyCallableCheck('pending governance', 'OnlyPendingGovernance()');

export const fnShouldOnlyBeCallableByJobOwner = createOnlyCallableCheck('job owner', 'OnlyJobOwner()');
/* TODO:
// createOnlyCallableCheck({allowedLabel1: string1, allowedLabel2: string2}, error: string)
//
// Add behaviours for slashers and disputers:
// export const fnShouldOnlyBeCallableByDisputerOrGovernance = createOnlyCallableCheck({'disputer','governance'}, 'OnlySlasherOrGovernance()');
// export const fnShouldOnlyBeCallableByJobOwnerOrGovernance = createOnlyCallableCheck({'disputer','governance'}, 'OnlyDisputerOrGovernance()');
*/

export function createOnlyCallableCheck(allowedLabel: string, error: string) {
  return (
    delayedContract: () => any, // TODO: fix any some day
    fnName: string,
